---
title: Urgent: court papers, frozen account, lien, or foreclosure
description: The first actions to take when a Maryland debt problem may have a deadline or immediate housing risk.
---
...
```mermaid
flowchart TD
  A[What arrived?] --> B{Court papers or a hearing date?}
  B -->|Yes| C[Calendar response/hearing deadline; Court Help or lawyer today]
  B -->|No| D{Frozen account or garnishment notice?}
  D -->|Yes| E[Preserve benefit-source records; review exemption process promptly]
  D -->|No| F{Foreclosure, sale, or eviction notice?}
  F -->|Yes| G[Housing counselor + lawyer; do not add a new lien]
  F -->|No| H{Judgment or lien notice?}
  H -->|Yes| I[Get the deed, payoff figures, and judgment to counsel]
  H -->|No| J[Collection letter: verify facts and use the Start Here worksheet]
```
